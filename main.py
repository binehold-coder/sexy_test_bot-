...
QUESTIONS = [
    {
        ...
        "text": {
            ...
            "uk": "В каком возрасте у тебя был первый секс?",
            "fr": "В каком возрасте у тебя был первый секс?",
        },
    },
    {
        "id": 2,
        ...
        "text": {
            ...
            "uk": "Сколько у тебя было половых партнеров за всю жизнь?",
            "fr": "Сколько у тебя было половых партнеров за всю жизнь?",
        },
    },
    {
        "id": 3,
        ...
        "text": {
            ...
            "uk": "Сколько у тебя половых партнеров сейчас?",
            "fr": "Сколько у тебя половых партнеров сейчас?",
        },
    },
    {
        "id": 4,
        ...
        "text": {
            ...
            "uk": "Как часто ты занимаешься сексом?",
            "fr": "Как часто ты занимаешься сексом?",
        },
        "options": ["often", "sometimes", "rarely", "never"],
        "labels": {
            "ru": {"often": "Часто", "sometimes": "Иногда", "rarely": "Редко", "never": "Никогда"},
            "uk": {"often": "Часто", "sometimes": "Иногда", "rarely": "Редко", "never": "Никогда"},
            "fr": {"often": "Часто", "sometimes": "Иногда", "rarely": "Редко", "never": "Никогда"},
        },
    },
    {
        "id": 5,
        ...
        "text": {
            ...
            "uk": "Сколько оргазмов ты можешь испытать с партнером за ночь?",
            "fr": "Сколько оргазмов ты можешь испытать с партнером за ночь?",
        },
    },
    {
        "id": 6,
        ...
        "text": {
            ...
            "uk": "Какова для тебя оптимальная продолжительность полового акта?",
            "fr": "Какова для тебя оптимальная продолжительность полового акта?",
        },
    },
    {
        "id": 7,
        ...
        "text": {
            ...
            "uk": "У тебя есть постоянный партнер?",
            "fr": "У тебя есть постоянный партнер?",
        },
        "options": ["yes", "no"],
        "labels": {
            "ru": {"yes": "Да", "no": "Нет"},
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Испытываешь ли ты сейчас сексуальную неудовлетворенность?",
            "fr": "Испытываешь ли ты сейчас сексуальную неудовлетворенность?",
        },
        "options": ["yes", "no"],
        "labels": {
            "ru": {"yes": "Да", "no": "Нет"},
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Как часто ты занимаешься онанизмом?",
            "fr": "Как часто ты занимаешься онанизмом?",
        },
        "options": ["often", "sometimes", "rarely", "never"],
        "labels": {
            "ru": {"often": "Часто", "sometimes": "Иногда", "rarely": "Редко", "never": "Никогда"},
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Смотришь ли ты порнофильмы? Посещаешь порносайты?",
            "fr": "Смотришь ли ты порнофильмы? Посещаешь порносайты?",
        },
        "options": ["yes", "no"],
        "labels": {
            "ru": {"yes": "Да", "no": "Нет"},
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Какой тип порно тебе наиболее интересен (традиционный, анальный, оральный, групповой, садо-мазо, разные извращения)?",
            "fr": "Какой тип порно тебе наиболее интересен (традиционный, анальный, оральный, групповой, садо-мазо, разные извращения)?",
        },
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Какой из вышеперечисленных видов секса тебе хочется испытать?",
            "fr": "Какой из вышеперечисленных видов секса тебе хочется испытать?",
        },
        "options": ["traditional", "anal", "oral", "group", "sadomaso", "perversions"],
        "labels": {
            "ru": {
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Привлекают ли тебя сексуально люди твоего пола?",
            "fr": "Привлекают ли тебя сексуально люди твоего пола?",
        },
        "options": ["yes", "no"],
        "labels": {
            "ru": {"yes": "Да", "no": "Нет"},
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "У тебя был секс с лицом своего пола?",
            "fr": "У тебя был секс с лицом своего пола?",
        },
        "options": ["yes", "no"],
        "labels": {
            "ru": {"yes": "Да", "no": "Нет"},
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Бывают ли у тебя фантазии о сексе с кем-то из знакомых/друзей?",
            "fr": "Бывают ли у тебя фантазии о сексе с кем-то из знакомых/друзей?",
        },
        "options": ["yes", "no"],
        "labels": {
            "ru": {"yes": "Да", "no": "Нет"},
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Хочешь ли ты иметь с ним сексуальную связь?",
            "fr": "Хочешь ли ты иметь с ним сексуальную связь?",
        },
        "options": ["yes", "no"],
        "labels": {
            "ru": {"yes": "Да", "no": "Нет"},
    ...
    },
    {
        ...
        "text": {
            ...
            "uk": "Укажи свой размер груди/члена",
            "fr": "Укажи свой размер груди/члена",
        },
    },
]
